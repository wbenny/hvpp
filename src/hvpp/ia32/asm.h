...
unsigned long long ia32_asm_in_dword_ex(
  _In_ unsigned short port,
  _In_ unsigned long long* rax,
  _In_ unsigned long long* rbx,
  _In_ unsigned long long* rcx,
  _In_ unsigned long long* rdx
  ) noexcept;

unsigned long long ia32_asm_out_dword_ex(
  _In_ unsigned short port,
  _In_ unsigned long long* rax,
  _In_ unsigned long long* rbx,
  _In_ unsigned long long* rcx,
